										...
										if (lvl3Part.hasPart()) {
											for (int l = 0; l < lvl3Part.getChildPart().size(); ++l) {
												...
												if (lvl4Part != null) {
													...
													toReturn.append("\t\t\tTitle: ").append(lvl4Part.getTitle())
															.append("\n");
													toReturn.append("\t\t\tText: ").append(lvl4Part.getText())
															.append("\n");
													...
													if (lvl4Part.getIndex() != null
															&& lvl4Part.getIndex().length() != 0) {
													...
													if (lvl4Part.hasPart()) {
														for (int m = 0; m < lvl4Part.getChildPart().size(); ++m) {
															...
															if (lvl5Part != null) {
																toReturn.append("\t\t\t\tIndex: ").append(m)
																		.append("\n");
																toReturn.append("\t\t\t\tTitle: ")
																		.append(lvl5Part.getTitle()).append("\n");
																toReturn.append("\t\t\t\tText: ")
																		.append(lvl5Part.getText()).append("\n");
																...
																if (lvl5Part.getIndex() != null
																		&& lvl5Part.getIndex().length() != 0) {
