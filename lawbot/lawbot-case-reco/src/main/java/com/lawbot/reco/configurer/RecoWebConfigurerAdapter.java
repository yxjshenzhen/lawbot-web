package com.lawbot.reco.configurer;
 ...
 */
@Configuration
public class RecoWebConfigurerAdapter extends WebMvcConfigurerAdapter {
	...
	private void addAccessInterceptor(InterceptorRegistry registry){
		registry.addInterceptor(new AccessInterceptor(PrivilegeManage.RECO_PRIV,listener)).addPathPatterns("/**")
		.excludePathPatterns("/error");
	}
