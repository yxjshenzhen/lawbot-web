package com.lawbot.reco.configurer.datasource;
...
@Configuration
@MapperScan(basePackages = "com.lawbot.reco.mapper", sqlSessionFactoryRef = "lawbotSqlSessionFactory")
public class LawbotDataSourceConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("lawbotDataSource") DataSource lawbotDataSource)
        ...
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath:com/lawbot/reco/mapper/*.xml"));
