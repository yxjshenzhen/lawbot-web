package com.lawbot.award.configurer;
 ...
 */
@Configuration
public class AwardWebConfigurerAdapter extends WebMvcConfigurerAdapter {
	...
	private void addAccessInterceptor(InterceptorRegistry registry){
		registry.addInterceptor(new AccessInterceptor(PrivilegeManage.AWARD_PRIV,listener)).addPathPatterns("/**")
